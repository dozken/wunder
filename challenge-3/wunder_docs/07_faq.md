...
> Mirrored from https://wundernn.io/connectome/docs/faq (fetched 2026-09-11).
...
Data overview for the formula. A higher score is better.
...
and sequence format are described in Data overview.
...
at the root. See Submission guide.
