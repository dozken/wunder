...
Local held-out best 0.666 (`full_seq_5ep`, epoch 3). See `RESUME.md` for the next runs.
...
| seq-loss + diff, 5 epochs (`full_seq_5ep`) | 0.6487 / 0.6597 / **0.6659** / 0.6654 / … | — | epoch 5 pending |
